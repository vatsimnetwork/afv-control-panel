...
<div class="container-fluid">
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form class="form-horizontal text-center" method="POST" action="{{ route('airports.update', ['airport' => $airport]) }}">
        @csrf
        @method('PATCH')
        <div class="row">
          ...
          <div class="col-12 col-md-9 mx-auto ml-md-0 px-auto pl-md-0">
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tr>
                  <td>
                    <input type="text" class="form-control @error('name') is-invalid @enderror text-center" name="name" placeholder="Name" value="{{ old('name') ?? $airport->name }}" minlength="4" maxlength="255" size="255" required>
                  </td>
                </tr>
              </table>
            </div>
